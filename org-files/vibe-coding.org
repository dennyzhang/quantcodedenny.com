...
---
** /review_diff_summary
Review the diff summary text.
- Evaluate clarity, persuasiveness, and readability.

Provide:
- Rating on the three criteria.
- Three detailed suggestions with rephrasing examples.
- A rewritten, improved version.
- A bullet-point rationale of changes.

Review code
- Check clarity, persuasiveness, readability & style.
- Provide an improved rewritten version.
- Give bullet-point rationale explaining what changed and why.
---
** /review_unittest

Read the given unit test and implementation code.

Identify issues such as missing mocks, skipped async tests, gaps in coverage.

Be direct and specific, listing the functions or cases with problems.
---
