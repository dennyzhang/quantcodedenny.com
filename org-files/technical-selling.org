...
One of the hardest skills I’ve learned as a tech lead is *scoping*: understanding the right problems to solve, sizing them correctly, and aligning them with my team’s capacity and organizational priorities. Good scoping sets the foundation for execution, influence, and impact. Poor scoping leads to wasted effort, missed deadlines, or over-committing the team.

Scoping for me means:
- Choosing the right problems that deliver meaningful impact.
- Defining clear boundaries to avoid scope creep.
- Aligning expectations across stakeholders, peers, and my team.
- Maximizing leverage by prioritizing work that scales or unlocks future opportunities.
...
- **Collaborative Partnership**: Align with peers and cross-functional teams effectively.
...
- **Focus on high-impact technical challenges**
  - Scenario: Spent energy on low-leverage issues like headcount conflicts.
  - Learning: Invest where technical expertise creates the most difference.

- **Be confident and assertive in requests**
  - Scenario: Accepted deprioritization of output validation and serving checks.
  - Learning: Advocate confidently for necessary changes.

- **Generalize problems and share knowledge**
  - Scenario: Solved problems in isolation, missing patterns across teams.
  - Learning: Step back, identify repeatable insights, and share broadly.

- **Avoid getting stuck on low-leverage problems**
  - Scenario: Ops-heavy problems like trunk health, metadata management, or minor feature inefficiencies.
  - Learning: Focus energy where my expertise creates leverage; skip low-impact or doomed-to-fail problems.

- **Clarify complex problems for others**
  - Scenario: HD feature management or feature metadata documentation.
  - Learning: Create concise one-pagers to enable efficient group discussion and feedback.

- **Set ambitious but clear goals**
  - Scenario: Daily or weekly tasks can feel lost without direction.
  - Learning: Big goals provide focus and motivation; help align small efforts with meaningful impact.
...
- **Leverage AI/LLMs to amplify thinking**
  ...
  - Learning: Use AI to speed up synthesis, not to automate thinking; combine insights with judgment.
...
| Area | Key Tasks | How I Leverage LLMs | Example Prompt |
|------|-----------|-------------------|----------------|
| Strategic Thinking & Problem Framing | Identify impactful problems, map stakeholders, clarify ownership, design resilient systems | Summarize strategy docs, highlight blind spots, map dependencies | Summarize key priorities from last 3 leadership updates. Highlight conflicts/dependencies. Compare 3 ML infra designs with trade-offs and team dependencies. |
| Execution & Operational Excellence | Lead SEV triage, build guardrails, identify bottlenecks, prioritize high-leverage tasks | Summarize SEV logs, generate scripts/checklists, simulate outcomes | Analyze last 3 SEVs, summarize recurring failure patterns, suggest automated mitigation strategies. Simulate outcomes for project trade-offs. |
| Influence, Mentorship & Collaboration | Mentor IC5/IC4, document best practices, share progress, lead without authority, focus discussions | Mock scenarios for training, polish drafts, summarize lessons | Create mock SEV scenario for IC5, highlight operational risks. Draft proposal explaining why caching pattern reduces errors. |
| Continuous Learning & Reflection | Weekly reflections, share lessons, document playbooks/runbooks, analyze recurring blind spots | Synthesize reflections, generate prompts, highlight gaps | Analyze last 3 SEVs, identify patterns I overlook. Highlight recurring gaps from design reviews, suggest learning exercises. |
| Mastering AI/LLM | Leverage AI to amplify thinking, embrace uncertainty, combine knowledge + action + insight | Apply meta-learning, strategic thinking, adaptability, resilience | Use LLM as senior staff+ mentor: reframe issues, identify incentives/risks, sharpen judgment, explore options/trade-offs, provide pragmatic recommendations. |
