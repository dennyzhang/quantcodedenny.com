...
2. Delta is advisory; prioritize OTM strikes to avoid assignment
...
7. Lower assignment risk when IV% is high.
...
**Tasks**
- If user-provided strike violates rules (OTM <20%, earnings within 10 days), flag it in "Mistake?" and provide "Next Fix" guidance.
...
7. Prefer strong fundamentals / support near strike.
