...
Connecting better at work is most powerful when it becomes a **daily habit** — small, consistent actions that naturally build trust, relationships, and impact. I focus on:
...
I can apply these micro-actions in any conversation or interaction:
...
I use this as a quick habit tracker:
...
- Notice small things about colleagues’ work — even minor updates count.
- Keep notes in one place (digital or notebook) for easy follow-up.
...
** Conclusion
Connecting better at work is both a **skill and a habit**. I make it automatic with small, daily micro-actions: **notice, follow through, and add value**. 
