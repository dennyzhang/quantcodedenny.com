...
Focus on high-leverage actions, eliminate noise, and consistently reinforce priorities that scale impact.
...
**** Quarterly Focus
- [ ] 1:1 time with each kid at least once per week
- [ ] Monthly date night with spouse
- [ ] Exercise 3x per week, sleep 7h/night
