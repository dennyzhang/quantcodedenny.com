...
** My Core Market-Value Routine
*** Weekly Habits
- [ ] **Learn broadly** → Attend 1 SEV review or design review
  - Goal: See real reliability/design problems and sharpen system judgment.
- [ ] **Connect cross-functionally** → 1 focused chat with an XFN lead
  - Goal: Understand their priorities and think beyond team scope.
- [ ] **Reflect & share** → Write 3–5 sentence summary of 1 key learning
  - Goal: Strengthen communication clarity and external legibility.
*** Monthly Habits
- [ ] **Host & lead** → Run 1 design or postmortem discussion
  - Goal: Practice influence, articulation, and technical leadership presence.
- [ ] **Mentor intentionally** → Coach 1–2 engineers on real problems
  - Goal: Scale impact through others and demonstrate multiplier behavior.
*** Quarterly Habits
- [ ] **Ship one improvement** → Deliver 1 measurable, end-to-end technical enhancement
  - Goal: Prove ownership and reliability through visible results.
- [ ] **Show the data** → Summarize wins in metrics or story form
  - Goal: Convert outcomes into portable, external-facing career signals.
*** Reflection Prompts
- Weekly: “Did I learn, connect, and share this week?”
- Quarterly: “What did I ship that improved the system and told my story?”
** Good Practices
