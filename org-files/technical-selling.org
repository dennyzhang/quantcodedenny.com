...
4. Maximizing impact while minimizing stress.
...
- **Challenge #4: Scaling influence and knowledge**
  - **LLM Use:** Draft proposals, mock scenarios, polish communications, extract repeatable lessons.
  - **Sample Prompt:** "Create a mock SEV scenario for IC5, highlighting operational risks. Draft a proposal showing why a new caching pattern reduces errors."
