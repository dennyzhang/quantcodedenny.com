...
* Look Better At Work: Weekly Runbook
:PROPERTIES:
...
1. **Business Value** – What tangible impact did your work have?
- **Complexity & Learning** – What challenges did you overcome, and what did you learn?

** Core Principles of Looking Better
| Principle                                  | What It Means                                             | How to Apply / Examples                                                                                                                                                      |
| ------------------------------------------ | --------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1. Make Your Impact Visible**            | Leaders care about outcomes, not effort.                  | Quantify results (dollars, time saved, efficiency), link to KPIs, compare before/after. *Example:* “Our work avoided $2M in lost revenue during peak traffic.”               |
| **2. Highlight Complexity & Learning**     | Show hidden challenges and what you learned.              | Explain hurdles, new methods, tools, or skills. *Example:* “Cut model training costs by 30% by debugging fragmented pipelines; built reusable monitoring tools for the org.” |
| **3. Leverage Others & Build Credibility** | Feedback from peers is more credible than self-promotion. | Share updates, recognize others, encourage allies to amplify your impact. Focus on consistent results over time.                                                             |
** Weekly Runbook
| Principle                                  | Daily / Weekly Actions                                                                                                                                                                 | Quick Tips                                                             |
| ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| **1. Make Your Impact Visible**            | - Reframe your latest project in **business terms**.<br>- Quantify results (dollars, time saved, efficiency).<br>- Connect outcomes to team/company KPIs.                              | Share short updates in team forums. Always link work to priorities.    |
| **2. Highlight Complexity & Learning**     | - Note 1–2 hidden challenges or obstacles from your last project.<br>- Capture key learnings or new skills.<br>- Think about what lessons others could reuse.                          | Keep a personal log; use examples when sharing in meetings or updates. |
| **3. Leverage Others & Build Credibility** | - Identify 1–2 allies who can amplify your work.<br>- Recognize contributions of others.<br>- Encourage peers to share positive feedback.<br>- Consistently deliver results over time. | Focus on sustained excellence, not one-off polish. Small wins matter.  |
** Common Pitfalls
...
* Connect Better At Work: A Practical Runbook
:PROPERTIES:
